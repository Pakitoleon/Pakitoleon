...
import { NoBlending as NoBlending12, ShaderMaterial as ShaderMaterial12, Uniform as Uniform12, Vector2 as Vector27 } from "three";
...
// src/materials/GaussianBlurMaterial.js
var GaussianBlurMaterial = class extends ShaderMaterial12 {
  constructor({ kernelSize = 35 } = {}) {
    super({
      ...
      uniforms: {
        ...
        direction: new Uniform12(new Vector27()),
        kernel: new Uniform12(null),
        scale: new Uniform12(new Vector27(1, 1))
      },
...
import { NoBlending as NoBlending15, ShaderMaterial as ShaderMaterial15, Uniform as Uniform15, UnsignedByteType as UnsignedByteType2 } from "three";
...
var OutlineMaterial = class extends ShaderMaterial16 {
  constructor(texelSize = new Vector28()) {
    super({
      name: "OutlineMaterial",
      uniforms: {
        inputBuffer: new Uniform16(null),
        texelSize: new Uniform16(new Vector28())
      },
...
import { NoBlending as NoBlending17, ShaderMaterial as ShaderMaterial17, Uniform as Uniform17, Vector2 as Vector29 } from "three";
...
var SMAAWeightsMaterial = class extends ShaderMaterial17 {
  constructor(texelSize = new Vector29(), resolution = new Vector29()) {
    super({
...
import { BasicDepthPacking as BasicDepthPacking7, Matrix4, NoBlending as NoBlending18, PerspectiveCamera as PerspectiveCamera4, ShaderMaterial as ShaderMaterial18, Uniform as Uniform18, Vector2 as Vector210 } from "three";
...
var SSAOMaterial = class extends ShaderMaterial18 {
  constructor(camera) {
    super({
      ...
      uniforms: {
        depthBuffer: new Uniform18(null),
        ...
        cameraNearFar: new Uniform18(new Vector210()),
        distanceCutoff: new Uniform18(new Vector210()),
        proximityCutoff: new Uniform18(new Vector210()),
        noiseScale: new Uniform18(new Vector210()),
...
import { EventDispatcher, Vector2 as Vector211 } from "three";
var AUTO_SIZE = -1;
var Resolution = class extends EventDispatcher {
  constructor(resizable, width = AUTO_SIZE, height = AUTO_SIZE, scale = 1) {
    ...
    this.preferred = new Vector211(width, height);
...
import { BasicDepthPacking as BasicDepthPacking11, UnsignedByteType as UnsignedByteType5 } from "three";
...
import { LinearFilter as LinearFilter3, sRGBEncoding as sRGBEncoding4, UnsignedByteType as UnsignedByteType7, WebGLRenderTarget as WebGLRenderTarget7 } from "three";
var KawaseBlurPass = class extends Pass {
  constructor({
    ...
    this.renderTargetA = new WebGLRenderTarget7(1, 1, {
...
import { LinearFilter as LinearFilter4, UnsignedByteType as UnsignedByteType8, WebGLRenderTarget as WebGLRenderTarget8 } from "three";
...
import { Color as Color3, MeshNormalMaterial, NearestFilter as NearestFilter5, WebGLRenderTarget as WebGLRenderTarget9 } from "three";
var NormalPass = class extends Pass {
  constructor(scene, camera, {
    ...
    this.renderTarget = renderTarget;
    if (this.renderTarget === void 0) {
      this.renderTarget = new WebGLRenderTarget9(1, 1, {
...
import { UnsignedByteType as UnsignedByteType9 } from "three";
...
var EffectComposer = class {
  ...
  setRenderer(renderer) {
    this.renderer = renderer;
    if (renderer !== null) {
      const size = renderer.getSize(new Vector212());
      const alpha = renderer.getContext().getContextAttributes().alpha;
      const frameBufferType = this.inputBuffer.texture.type;
      if (frameBufferType === UnsignedByteType10 && renderer.outputEncoding === sRGBEncoding5) {
        this.inputBuffer.texture.encoding = sRGBEncoding5;
        this.outputBuffer.texture.encoding = sRGBEncoding5;
        this.inputBuffer.dispose();
        this.outputBuffer.dispose();
      }
  ...
  createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
    ...
    const size = renderer === null ? new Vector212() : renderer.getDrawingBufferSize(new Vector212());
    const options = {
    ...
    let renderTarget;
    if (multisampling > 0) {
      renderTarget = Number(REVISION3.replace(/\D+/g, "")) < 138 ? new WebGLMultisampleRenderTarget(size.width, size.height, options) : new WebGLRenderTarget10(size.width, size.height, options);
      renderTarget.ignoreDepthForMultisampleCopy = false;
      renderTarget.samples = multisampling;
    } else {
      renderTarget = new WebGLRenderTarget10(size.width, size.height, options);
    }
    if (type === UnsignedByteType10 && renderer !== null && renderer.outputEncoding === sRGBEncoding5) {
      renderTarget.texture.encoding = sRGBEncoding5;
    }
  ...
  addPass(pass, index) {
    ...
    const renderer = this.renderer;
    const drawingBufferSize = renderer.getDrawingBufferSize(new Vector212());
    const alpha = renderer.getContext().getContextAttributes().alpha;
    const frameBufferType = this.inputBuffer.texture.type;
...
import { EventDispatcher as EventDispatcher2, Uniform as Uniform19 } from "three";
...
import { LinearFilter as LinearFilter6, sRGBEncoding as sRGBEncoding6, Uniform as Uniform20, WebGLRenderTarget as WebGLRenderTarget11 } from "three";

// src/effects/Effect.js
import { BasicDepthPacking as BasicDepthPacking12, EventDispatcher as EventDispatcher3, Scene as Scene2 } from "three";
...
var ChromaticAberrationEffect = class extends Effect {
  constructor({
    blendFunction,
    offset = new Vector213(1e-3, 5e-4),
    ...
    super("ChromaticAberrationEffect", chromatic_aberration_default, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ...
        ["modulationOffset", new Uniform24(modulationOffset)]
      ])
    });
...
import { BasicDepthPacking as BasicDepthPacking13, LinearFilter as LinearFilter7, sRGBEncoding as sRGBEncoding7, Uniform as Uniform25, UnsignedByteType as UnsignedByteType11, WebGLRenderTarget as WebGLRenderTarget12 } from "three";
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (frameBufferType !== void 0) {
      ...
      if (renderer.outputEncoding === sRGBEncoding7) {
        this.renderTarget.texture.encoding = sRGBEncoding7;
        this.renderTargetNear.texture.encoding = sRGBEncoding7;
        this.renderTargetFar.texture.encoding = sRGBEncoding7;
        this.renderTargetMasked.texture.encoding = sRGBEncoding7;
      }
    }
  }
};
...
import { Uniform as Uniform26, Vector2 as Vector214 } from "three";
...
var DotScreenEffect = class extends Effect {
  constructor({ blendFunction, angle = Math.PI * 0.5, scale = 1 } = {}) {
    super("DotScreenEffect", dot_screen_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["angle", new Uniform26(new Vector214())],
...
import { NearestFilter as NearestFilter6, RepeatWrapping, RGBAFormat as RGBAFormat3, Uniform as Uniform28, Vector2 as Vector215 } from "three";
...
var NoiseTexture = class extends DataTexture {
  constructor(width, height, format = LuminanceFormat, type = UnsignedByteType12) {
...
var GlitchEffect = class extends Effect {
  constructor({
    ...
    delay = new Vector215(1.5, 3.5),
    duration = new Vector215(0.6, 1),
    strength = new Vector215(0.3, 1),
    columns = 0.05,
    ratio = 0.85,
    ...
    super("GlitchEffect", glitch_default, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ...
        ["seeds", new Uniform28(new Vector215())],
        ["distortion", new Uniform28(new Vector215())]
      ])
    });
    ...
    this.breakPoint = new Vector215(randomFloat(this.delay.x, this.delay.y), randomFloat(this.duration.x, this.duration.y));
...
var GodRaysEffect = class extends Effect {
  constructor(camera, lightSource, {
    ...
    this.screenPosition = new Vector216();
    this.renderTargetA = new WebGLRenderTarget13(1, 1, {
      minFilter: LinearFilter8,
      magFilter: LinearFilter8,
      stencilBuffer: false,
      depthBuffer: false
    });
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (frameBufferType !== void 0) {
      ...
      if (renderer.outputEncoding === sRGBEncoding8) {
        this.renderTargetA.texture.encoding = sRGBEncoding8;
        this.renderTargetB.texture.encoding = sRGBEncoding8;
        this.renderTargetLight.texture.encoding = sRGBEncoding8;
      }
    }
  }
};
...
import { Uniform as Uniform30, Vector2 as Vector217 } from "three";
...
var GridEffect = class extends Effect {
  constructor({ blendFunction = BlendFunction.OVERLAY, scale = 1, lineWidth = 0 } = {}) {
    super("GridEffect", grid_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["scale", new Uniform30(new Vector217())],
...
import { FloatType as FloatType4, HalfFloatType, Uniform as Uniform32 } from "three";
...
var LUT1DEffect = class extends Effect {
  constructor(lut, { blendFunction = BlendFunction.SET } = {}) {
    super("LUT1DEffect", lut_1d_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([["lut", new Uniform32(null)]])
    });
    this.lut = lut;
  }
  get lut() {
  ...
  set lut(value) {
    ...
    if (value && (value.type === FloatType4 || value.type === HalfFloatType)) {
...
var LookupTexture = class extends DataTexture3D {
  constructor(data, size) {
    ...
    this.minFilter = LinearFilter9;
    this.magFilter = LinearFilter9;
  ...
  toDataTexture() {
    ...
    texture.minFilter = LinearFilter9;
    texture.magFilter = LinearFilter9;
...
var LUT3DEffect = class extends Effect {
  constructor(lut, {
    ...
    inputEncoding = sRGBEncoding10
  } = {}) {
    super("LUT3DEffect", lut_3d_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["lut", new Uniform33(null)],
        ["scale", new Uniform33(new Vector34())],
        ["offset", new Uniform33(new Vector34())],
        ["domainMin", new Uniform33(null)],
        ["domainMax", new Uniform33(null)]
      ])
    });
  ...
  configureTetrahedralInterpolation() {
    const lut = this.lut;
    if (lut !== null) {
      lut.minFilter = LinearFilter10;
      lut.magFilter = LinearFilter10;
...
import { Color as Color6, LinearFilter as LinearFilter11, RepeatWrapping as RepeatWrapping2, Uniform as Uniform34, UnsignedByteType as UnsignedByteType14, WebGLRenderTarget as WebGLRenderTarget14 } from "three";
...
var OutlineEffect = class extends Effect {
  constructor(scene, camera, {
    ...
    super("OutlineEffect", outline_default3, {
      uniforms: /* @__PURE__ */ new Map([
        ["maskTexture", new Uniform34(null)],
        ["edgeTexture", new Uniform34(null)],
        ["edgeStrength", new Uniform34(edgeStrength)],
        ["visibleEdgeColor", new Uniform34(new Color6(visibleEdgeColor))],
        ["hiddenEdgeColor", new Uniform34(new Color6(hiddenEdgeColor))],
        ["pulse", new Uniform34(1)],
        ["patternScale", new Uniform34(patternScale)],
        ["patternTexture", new Uniform34(null)]
      ])
    });
    ...
    this.scene = scene;
    this.camera = camera;
    this.renderTargetMask = new WebGLRenderTarget14(1, 1, {
...
var PixelationEffect = class extends Effect {
  constructor(granularity = 30) {
    super("PixelationEffect", pixelation_default, {
      uniforms: /* @__PURE__ */ new Map([
        ["active", new Uniform35(false)],
        ["d", new Uniform35(new Vector218())]
      ])
    });
...
import { Uniform as Uniform36, Vector4 as Vector42 } from "three";
...
var RealisticBokehEffect = class extends Effect {
  constructor({
    ...
    super("RealisticBokehEffect", realistic_bokeh_default, {
      ...
      attributes: EffectAttribute.CONVOLUTION | EffectAttribute.DEPTH,
      uniforms: /* @__PURE__ */ new Map([
        ["focus", new Uniform36(focus)],
        ["focalLength", new Uniform36(focalLength)],
        ["fStop", new Uniform36(fStop)],
        ["luminanceThreshold", new Uniform36(luminanceThreshold)],
        ["luminanceGain", new Uniform36(luminanceGain)],
        ["bias", new Uniform36(bias)],
        ["fringe", new Uniform36(fringe)],
        ["maxBlur", new Uniform36(maxBlur)],
        ["dof", new Uniform36(null)]
      ])
    });
    this.rings = rings;
...
import { Uniform as Uniform37, Vector2 as Vector219 } from "three";
...
var ScanlineEffect = class extends Effect {
  constructor({ blendFunction = BlendFunction.OVERLAY, density = 1.25, scrollSpeed = 0 } = {}) {
    super("ScanlineEffect", scanlines_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["count", new Uniform37(0)],
        ["scrollSpeed", new Uniform37(0)]
      ])
    });
...
import { Uniform as Uniform38, Vector2 as Vector220, Vector3 as Vector35 } from "three";
...
var ShockWaveEffect = class extends Effect {
  constructor(camera, position = new Vector35(), {
    ...
    super("ShockWaveEffect", shock_wave_default, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ["active", new Uniform38(false)],
        ["center", new Uniform38(new Vector220(0.5, 0.5))],
        ["cameraDistance", new Uniform38(1)],
        ["size", new Uniform38(1)],
        ["radius", new Uniform38(-waveSize)],
        ["maxRadius", new Uniform38(maxRadius)],
        ["waveSize", new Uniform38(waveSize)],
        ["amplitude", new Uniform38(amplitude)]
      ])
    });
...
var SelectiveBloomEffect = class extends BloomEffect {
  constructor(scene, camera, options) {
    ...
    this.renderTargetMasked = new WebGLRenderTarget15(1, 1, {
      minFilter: LinearFilter12,
      magFilter: LinearFilter12,
      stencilBuffer: false,
      depthBuffer: false
    });
...
import { Uniform as Uniform39 } from "three";
...
var SepiaEffect = class extends Effect {
  constructor({ blendFunction, intensity = 1 } = {}) {
    super("SepiaEffect", sepia_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["intensity", new Uniform39(intensity)]
      ])
    });
  }
  get intensity() {
...
var SMAAEffect = class extends Effect {
  constructor({
    ...
    this.renderTargetEdges = new WebGLRenderTarget16(1, 1, {
    ...
    loadingManager.onLoad = () => {
      ...
      areaTexture.magFilter = LinearFilter13;
      areaTexture.minFilter = LinearFilter13;
...
var SSAOEffect = class extends Effect {
  constructor(camera, normalBuffer, {
    ...
    this.renderTargetAO = new WebGLRenderTarget17(1, 1, {
      minFilter: LinearFilter14,
...
import { Uniform as Uniform42, UnsignedByteType as UnsignedByteType15 } from "three";
  ...
  set texture(value) {
    ...
    if (prevTexture !== value) {
      ...
      if (value !== null) {
        ...
        if (value.type !== UnsignedByteType15) {
...
import { LinearFilter as LinearFilter15, LinearMipmapLinearFilter, Uniform as Uniform43, WebGLRenderTarget as WebGLRenderTarget18 } from "three";
...
var ToneMappingEffect = class extends Effect {
  constructor({
    ...
    super("ToneMappingEffect", tone_mapping_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["luminanceBuffer", new Uniform43(null)],
        ["maxLuminance", new Uniform43(maxLuminance)],
        ["whitePoint", new Uniform43(whitePoint)],
        ["middleGrey", new Uniform43(middleGrey)],
        ["averageLuminance", new Uniform43(averageLuminance)]
      ])
    });
    this.renderTargetLuminance = new WebGLRenderTarget18(1, 1, {
      minFilter: LinearMipmapLinearFilter,
      magFilter: LinearFilter15,
      stencilBuffer: false,
      depthBuffer: false
    });
...
import { Uniform as Uniform44 } from "three";
...
var VignetteEffect = class extends Effect {
  constructor({
    ...
    super("VignetteEffect", vignette_default, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ["offset", new Uniform44(offset)],
        ["darkness", new Uniform44(darkness)]
      ])
    });
  }
  get technique() {
