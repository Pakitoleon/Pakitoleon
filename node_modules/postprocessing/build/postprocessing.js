...
var POSTPROCESSING = (() => {
    ...
    constructor(fill = false, foreground = false) {
      super({
        ...
        uniforms: {
          ...
          scale: new import_three2.Uniform(new import_three2.Vector2(1, 1))
        },
    ...
    constructor(texelSize = new import_three5.Vector4()) {
      super({
        ...
        uniforms: {
          ...
          scale: new import_three5.Uniform(new import_three5.Vector2(1, 1)),
  ...
  // src/materials/EdgeDetectionMaterial.js
  var EdgeDetectionMaterial = class extends import_three11.ShaderMaterial {
    constructor(texelSize = new import_three11.Vector2(), mode = EdgeDetectionMode.COLOR) {
      super({
        ...
        uniforms: {
          ...
          depthBuffer: new import_three11.Uniform(null),
          predicationBuffer: new import_three11.Uniform(null),
          texelSize: new import_three11.Uniform(texelSize)
        },
    ...
    setDepthBuffer(buffer, depthPacking = import_three11.BasicDepthPacking) {
      this.depthBuffer = buffer;
      this.depthPacking = depthPacking;
    }
  ...
  var EffectMaterial = class extends import_three12.ShaderMaterial {
    constructor(shaderParts, defines, uniforms, camera, dithering = false) {
      super({
        ...
        uniforms: {
          ...
          resolution: new import_three12.Uniform(new import_three12.Vector2()),
          texelSize: new import_three12.Uniform(new import_three12.Vector2()),
          cameraNear: new import_three12.Uniform(0.3),
          cameraFar: new import_three12.Uniform(1e3),
          aspect: new import_three12.Uniform(1),
          time: new import_three12.Uniform(0)
        },
    ...
    setShaderParts(shaderParts) {
      this.fragmentShader = effect_default.replace(Section.FRAGMENT_HEAD, shaderParts.get(Section.FRAGMENT_HEAD)).replace(Section.FRAGMENT_MAIN_UV, shaderParts.get(Section.FRAGMENT_MAIN_UV)).replace(Section.FRAGMENT_MAIN_IMAGE, shaderParts.get(Section.FRAGMENT_MAIN_IMAGE));
      this.vertexShader = effect_default2.replace(Section.VERTEX_HEAD, shaderParts.get(Section.VERTEX_HEAD)).replace(Section.VERTEX_MAIN_SUPPORT, shaderParts.get(Section.VERTEX_MAIN_SUPPORT));
      this.needsUpdate = true;
      return this;
    }
    setDefines(defines) {
    ...
    adoptCameraSettings(camera) {
      if (camera) {
        this.uniforms.cameraNear.value = camera.near;
        this.uniforms.cameraFar.value = camera.far;
        if (camera instanceof import_three12.PerspectiveCamera) {
          this.defines.PERSPECTIVE_CAMERA = "1";
        } else {
          delete this.defines.PERSPECTIVE_CAMERA;
        }
  ...
  // src/materials/GaussianBlurMaterial.js
  var GaussianBlurMaterial = class extends import_three13.ShaderMaterial {
    constructor({ kernelSize = 35 } = {}) {
      super({
        ...
        uniforms: {
          ...
          direction: new import_three13.Uniform(new import_three13.Vector2()),
          kernel: new import_three13.Uniform(null),
          scale: new import_three13.Uniform(new import_three13.Vector2(1, 1))
        },
  ...
  // src/materials/GodRaysMaterial.js
  var GodRaysMaterial = class extends import_three14.ShaderMaterial {
    constructor(lightPosition) {
      super({
        ...
        uniforms: {
          ...
          lightPosition: new import_three14.Uniform(lightPosition),
          density: new import_three14.Uniform(1),
          decay: new import_three14.Uniform(1),
          weight: new import_three14.Uniform(1),
          exposure: new import_three14.Uniform(1),
          clampMax: new import_three14.Uniform(1)
        },
  ...
  // src/materials/LuminanceMaterial.js
  var LuminanceMaterial = class extends import_three15.ShaderMaterial {
    constructor(colorOutput = false, luminanceRange = null) {
      super({
        name: "LuminanceMaterial",
        uniforms: {
          inputBuffer: new import_three15.Uniform(null),
          threshold: new import_three15.Uniform(0),
          smoothing: new import_three15.Uniform(1),
          range: new import_three15.Uniform(null)
        },
  ...
  // src/materials/MaskMaterial.js
  var MaskMaterial = class extends import_three16.ShaderMaterial {
    constructor(maskTexture = null) {
      super({
        name: "MaskMaterial",
        uniforms: {
          maskTexture: new import_three16.Uniform(maskTexture),
          inputBuffer: new import_three16.Uniform(null),
          strength: new import_three16.Uniform(1)
        },
    ...
    set maskTexture(value) {
      ...
      if (value.type !== import_three16.UnsignedByteType) {
  ...
  // src/materials/OutlineMaterial.js
  var OutlineMaterial = class extends import_three17.ShaderMaterial {
    constructor(texelSize = new import_three17.Vector2()) {
      super({
        name: "OutlineMaterial",
        uniforms: {
          inputBuffer: new import_three17.Uniform(null),
          texelSize: new import_three17.Uniform(new import_three17.Vector2())
        },
  ...
  // src/materials/SMAAWeightsMaterial.js
  var SMAAWeightsMaterial = class extends import_three18.ShaderMaterial {
    constructor(texelSize = new import_three18.Vector2(), resolution = new import_three18.Vector2()) {
      super({
        ...
        uniforms: {
          ...
          searchTexture: new import_three18.Uniform(null),
          areaTexture: new import_three18.Uniform(null),
          resolution: new import_three18.Uniform(resolution),
          texelSize: new import_three18.Uniform(texelSize)
        },
  ...
  // src/materials/SSAOMaterial.js
  var SSAOMaterial = class extends import_three19.ShaderMaterial {
    constructor(camera) {
      super({
        name: "SSAOMaterial",
        defines: {
        ...
        uniforms: {
          depthBuffer: new import_three19.Uniform(null),
          normalBuffer: new import_three19.Uniform(null),
          normalDepthBuffer: new import_three19.Uniform(null),
          noiseTexture: new import_three19.Uniform(null),
          inverseProjectionMatrix: new import_three19.Uniform(new import_three19.Matrix4()),
          projectionMatrix: new import_three19.Uniform(new import_three19.Matrix4()),
          texelSize: new import_three19.Uniform(new import_three19.Vector2()),
          cameraNearFar: new import_three19.Uniform(new import_three19.Vector2()),
          distanceCutoff: new import_three19.Uniform(new import_three19.Vector2()),
          proximityCutoff: new import_three19.Uniform(new import_three19.Vector2()),
          noiseScale: new import_three19.Uniform(new import_three19.Vector2()),
          minRadiusScale: new import_three19.Uniform(0.33),
          intensity: new import_three19.Uniform(1),
          fade: new import_three19.Uniform(0.01),
          bias: new import_three19.Uniform(0)
        },
      ...
      this.toneMapped = false;
      this.adoptCameraSettings(camera);
      this.resolution = new import_three19.Vector2();
      this.r = 1;
    }
    get near() {
    ...
    setDepthBuffer(buffer, depthPacking = import_three19.BasicDepthPacking) {
      this.depthBuffer = buffer;
      this.depthPacking = depthPacking;
    }
    ...
    adoptCameraSettings(camera) {
      if (camera) {
        ...
        if (camera instanceof import_three19.PerspectiveCamera) {
          this.defines.PERSPECTIVE_CAMERA = "1";
        } else {
          delete this.defines.PERSPECTIVE_CAMERA;
        }
  ...
  var dummyCamera = new import_three20.Camera();
  var geometry = null;
  function getFullscreenTriangle() {
    if (geometry === null) {
      const vertices = new Float32Array([-1, -1, 0, 3, -1, 0, -1, 3, 0]);
      const uvs = new Float32Array([0, 0, 2, 0, 0, 2]);
      geometry = new import_three20.BufferGeometry();
      if (geometry.setAttribute !== void 0) {
        geometry.setAttribute("position", new import_three20.BufferAttribute(vertices, 3));
        geometry.setAttribute("uv", new import_three20.BufferAttribute(uvs, 2));
      } else {
        geometry.addAttribute("position", new import_three20.BufferAttribute(vertices, 3));
        geometry.addAttribute("uv", new import_three20.BufferAttribute(uvs, 2));
      }
    }
    return geometry;
  }
  var Pass = class {
    constructor(name = "Pass", scene = new import_three20.Scene(), camera = dummyCamera) {
      this.name = name;
      this.renderer = null;
      this.scene = scene;
      this.camera = camera;
    ...
    set fullscreenMaterial(value) {
      ...
      if (screen !== null) {
        ...
        screen = new import_three20.Mesh(getFullscreenTriangle(), value);
        screen.frustumCulled = false;
        if (this.scene === null) {
          this.scene = new import_three20.Scene();
        }
    ...
    setDepthTexture(depthTexture, depthPacking = import_three20.BasicDepthPacking) {
    }
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        ...
        if (property !== null && typeof property.dispose === "function") {
          if (property instanceof import_three20.Scene || property === this.renderer) {
            continue;
          }
          this[key].dispose();
        }
  ...
  var CopyPass = class extends Pass {
    constructor(renderTarget, autoResize = true) {
      ...
      if (renderTarget === void 0) {
        this.renderTarget = new import_three21.WebGLRenderTarget(1, 1, {
          minFilter: import_three21.LinearFilter,
          magFilter: import_three21.LinearFilter,
          stencilBuffer: false,
          depthBuffer: false
        });
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        if (frameBufferType !== import_three21.UnsignedByteType) {
          this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
        } else if (renderer.outputEncoding === import_three21.sRGBEncoding) {
          this.renderTarget.texture.encoding = import_three21.sRGBEncoding;
        }
      }
    }
  };
  ...
  var AdaptiveLuminancePass = class extends Pass {
    constructor(luminanceBuffer, { minLuminance = 0.01, adaptationRate = 1 } = {}) {
      ...
      this.needsSwap = false;
      this.renderTargetPrevious = new import_three22.WebGLRenderTarget(1, 1, {
        minFilter: import_three22.NearestFilter,
        magFilter: import_three22.NearestFilter,
        stencilBuffer: false,
        depthBuffer: false
      });
  ...
  var color = new import_three23.Color();
  ...
  var AUTO_SIZE = -1;
  var Resolution = class extends import_three24.EventDispatcher {
    constructor(resizable, width = AUTO_SIZE, height = AUTO_SIZE, scale = 1) {
      super();
      this.resizable = resizable;
      this.base = new import_three24.Vector2(1, 1);
      this.preferred = new import_three24.Vector2(width, height);
        ...
        if (node.isMesh) {
          ...
          if (node.material.flatShading) {
            switch (node.material.side) {
              case import_three25.DoubleSide:
                materials = this.materialsFlatShadedDoubleSide;
                break;
              case import_three25.BackSide:
    ...
    setMaterial(material) {
      ...
      if (material !== null) {
        ...
        for (const m2 of materials) {
          ...
          m2.side = import_three25.FrontSide;
        }
        materials[2].skinning = true;
        this.materialsBackSide = materials.map((m2) => {
          const c2 = m2.clone();
          c2.uniforms = Object.assign({}, material.uniforms);
          c2.side = import_three25.BackSide;
          return c2;
        });
        this.materialsDoubleSide = materials.map((m2) => {
          const c2 = m2.clone();
          c2.uniforms = Object.assign({}, material.uniforms);
          c2.side = import_three25.DoubleSide;
          return c2;
        });
  ...
  var DepthPass = class extends Pass {
    constructor(scene, camera, {
      ...
      super("DepthPass");
      this.needsSwap = false;
      this.renderPass = new RenderPass(scene, camera, new import_three26.MeshDepthMaterial({
        depthPacking: import_three26.RGBADepthPacking
      }));
      const renderPass = this.renderPass;
      renderPass.skipShadowMapUpdate = true;
      renderPass.ignoreBackground = true;
      const clearPass = renderPass.getClearPass();
      clearPass.overrideClearColor = new import_three26.Color(16777215);
      clearPass.overrideClearAlpha = 1;
      this.renderTarget = renderTarget;
      if (this.renderTarget === void 0) {
        this.renderTarget = new import_three26.WebGLRenderTarget(1, 1, {
  ...
  var DepthDownsamplingPass = class extends Pass {
    constructor({
      ...
      this.needsSwap = false;
      this.renderTarget = new import_three27.WebGLRenderTarget(1, 1, {
        minFilter: import_three27.NearestFilter,
        magFilter: import_three27.NearestFilter,
        stencilBuffer: false,
        depthBuffer: false,
        type: import_three27.FloatType
      });
  ...
  var DepthCopyPass = class extends Pass {
    constructor({ depthPacking = import_three28.RGBADepthPacking } = {}) {
      super("DepthCopyPass");
      ...
      this.renderTarget = new import_three28.WebGLRenderTarget(1, 1, {
        type: depthPacking === import_three28.RGBADepthPacking ? import_three28.UnsignedByteType : import_three28.FloatType,
  ...
  var DepthPickingPass = class extends DepthCopyPass {
    constructor({ depthPacking = import_three29.RGBADepthPacking, mode = DepthCopyMode.SINGLE } = {}) {
      super({ depthPacking });
      this.name = "DepthPickingPass";
      this.fullscreenMaterial.mode = mode;
      this.pixelBuffer = depthPacking === import_three29.RGBADepthPacking ? new Uint8Array(4) : new Float32Array(4);
      this.callback = null;
    }
    readDepth(ndc) {
    ...
    render(renderer, inputBuffer, outputBuffer, deltaTime, stencilTest) {
      ...
      if (this.callback !== null) {
        ...
        const packed = renderTarget.texture.type !== import_three29.FloatType;
        let x = 0, y = 0;
...
`;
  ...
  var EffectPass = class extends Pass {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      this.updateMaterial();
      this.verifyResources();
      if (frameBufferType !== void 0 && frameBufferType !== import_three30.UnsignedByteType) {
        this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
      }
    }
    dispose() {
  ...
  var GaussianBlurPass = class extends Pass {
    constructor({
      ...
      this.renderTargetA = new import_three31.WebGLRenderTarget(1, 1, {
        minFilter: import_three31.LinearFilter,
        magFilter: import_three31.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false
      });
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        if (frameBufferType !== import_three31.UnsignedByteType) {
          this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
        } else if (renderer.outputEncoding === import_three31.sRGBEncoding) {
          this.renderTargetA.texture.encoding = import_three31.sRGBEncoding;
          this.renderTargetB.texture.encoding = import_three31.sRGBEncoding;
        }
      }
    }
  };
  ...
  var KawaseBlurPass = class extends Pass {
    constructor({
      ...
      this.renderTargetA = new import_three32.WebGLRenderTarget(1, 1, {
        minFilter: import_three32.LinearFilter,
        magFilter: import_three32.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false
      });
      this.renderTargetA.texture.name = "Blur.Target.A";
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        this.renderTargetA.texture.type = frameBufferType;
        this.renderTargetB.texture.type = frameBufferType;
        if (frameBufferType !== import_three32.UnsignedByteType) {
          this.blurMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
        } else if (renderer.outputEncoding === import_three32.sRGBEncoding) {
          this.renderTargetA.texture.encoding = import_three32.sRGBEncoding;
          this.renderTargetB.texture.encoding = import_three32.sRGBEncoding;
        }
      }
    }
    static get AUTO_SIZE() {
  ...
  var LuminancePass = class extends Pass {
    constructor({
      ...
      this.renderTarget = renderTarget;
      if (this.renderTarget === void 0) {
        this.renderTarget = new import_three33.WebGLRenderTarget(1, 1, {
          minFilter: import_three33.LinearFilter,
          magFilter: import_three33.LinearFilter,
          stencilBuffer: false,
          depthBuffer: false
        });
  ...
  var NormalPass = class extends Pass {
    constructor(scene, camera, {
      ...
      super("NormalPass");
      this.needsSwap = false;
      this.renderPass = new RenderPass(scene, camera, new import_three34.MeshNormalMaterial());
      const renderPass = this.renderPass;
      renderPass.setBackgroundDisabled(true);
      renderPass.setShadowMapDisabled(true);
      const clearPass = renderPass.getClearPass();
      clearPass.setOverrideClearColor(new import_three34.Color(7829503));
      clearPass.setOverrideClearAlpha(1);
      this.renderTarget = renderTarget;
      if (this.renderTarget === void 0) {
        this.renderTarget = new import_three34.WebGLRenderTarget(1, 1, {
          minFilter: import_three34.NearestFilter,
          magFilter: import_three34.NearestFilter,
          stencilBuffer: false
        });
  ...
  var EffectComposer = class {
    ...
    setRenderer(renderer) {
      this.renderer = renderer;
      if (renderer !== null) {
        const size = renderer.getSize(new import_three36.Vector2());
        const alpha = renderer.getContext().getContextAttributes().alpha;
        const frameBufferType = this.inputBuffer.texture.type;
        if (frameBufferType === import_three36.UnsignedByteType && renderer.outputEncoding === import_three36.sRGBEncoding) {
          this.inputBuffer.texture.encoding = import_three36.sRGBEncoding;
          this.outputBuffer.texture.encoding = import_three36.sRGBEncoding;
          this.inputBuffer.dispose();
          this.outputBuffer.dispose();
        }
    ...
    createDepthTexture() {
      const depthTexture = this.depthTexture = new import_three36.DepthTexture();
      this.inputBuffer.depthTexture = depthTexture;
      this.inputBuffer.dispose();
      if (this.inputBuffer.stencilBuffer) {
        depthTexture.format = import_three36.DepthStencilFormat;
        depthTexture.type = import_three36.UnsignedInt248Type;
      } else {
        depthTexture.type = import_three36.UnsignedIntType;
      }
      return depthTexture;
    }
    deleteDepthTexture() {
    ...
    createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
      ...
      const size = renderer === null ? new import_three36.Vector2() : renderer.getDrawingBufferSize(new import_three36.Vector2());
      const options = {
        minFilter: import_three36.LinearFilter,
        magFilter: import_three36.LinearFilter,
        stencilBuffer,
        depthBuffer,
        type
      };
      let renderTarget;
      if (multisampling > 0) {
        renderTarget = Number(import_three36.REVISION.replace(/\D+/g, "")) < 138 ? new import_three36.WebGLMultisampleRenderTarget(size.width, size.height, options) : new import_three36.WebGLRenderTarget(size.width, size.height, options);
        renderTarget.ignoreDepthForMultisampleCopy = false;
        renderTarget.samples = multisampling;
      } else {
        renderTarget = new import_three36.WebGLRenderTarget(size.width, size.height, options);
      }
      if (type === import_three36.UnsignedByteType && renderer !== null && renderer.outputEncoding === import_three36.sRGBEncoding) {
        renderTarget.texture.encoding = import_three36.sRGBEncoding;
      }
    ...
    addPass(pass, index) {
      ...
      const renderer = this.renderer;
      const drawingBufferSize = renderer.getDrawingBufferSize(new import_three36.Vector2());
      const alpha = renderer.getContext().getContextAttributes().alpha;
      const frameBufferType = this.inputBuffer.texture.type;
  ...
  var color_burn_default = "float blend(const in float x,const in float y){return(y==0.0)?0.0:max(1.0-(1.0-x)/y,0.0);}vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec4 z=vec4(blend(x.r,y.r),blend(x.g,y.g),blend(x.b,y.b),blend(x.a,y.a));return mix(x,z,opacity);}";

  // src/effects/blending/glsl/color-dodge.frag
  var color_dodge_default = "float blend(const in float x,const in float y){return(y>=1.0)?y:min(x/max(1.0-y,1e-9),1.0);}vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec4 z=vec4(blend(x.r,y.r),blend(x.g,y.g),blend(x.b,y.b),blend(x.a,y.a));return mix(x,z,opacity);}";
  ...
  var divide_default = "float blend(const in float x,const in float y){return(y>0.0)?x/y:1e12;}vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec4 z=vec4(blend(x.r,y.r),blend(x.g,y.g),blend(x.b,y.b),blend(x.a,y.a));return mix(x,z,opacity);}";
  ...
  var overlay_default = "float blend(const in float x,const in float y){return(x<0.5)?(2.0*x*y):(1.0-2.0*(1.0-x)*(1.0-y));}vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec4 z=vec4(blend(x.r,y.r),blend(x.g,y.g),blend(x.b,y.b),blend(x.a,y.a));return mix(x,z,opacity);}";

  // src/effects/blending/glsl/reflect.frag
  var reflect_default = "float blend(const in float x,const in float y){return(y>=1.0)?y:min(x*x/max(1.0-y,1e-9),1.0);}vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec4 z=vec4(blend(x.r,y.r),blend(x.g,y.g),blend(x.b,y.b),blend(x.a,y.a));return mix(x,z,opacity);}";

  // src/effects/blending/glsl/set.frag
  var set_default = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return y;}";

  // src/effects/blending/glsl/screen.frag
  var screen_default = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,1.0-(1.0-x)*(1.0-y),opacity);}";

  // src/effects/blending/glsl/soft-light.frag
  var soft_light_default = "float blend(const in float x,const in float y){return(y<0.5)?(2.0*x*y+x*x*(1.0-2.0*y)):(sqrt(x)*(2.0*y-1.0)+2.0*x*(1.0-y));}vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec4 z=vec4(blend(x.r,y.r),blend(x.g,y.g),blend(x.b,y.b),blend(x.a,y.a));return mix(x,z,opacity);}";
  ...
  var Effect = class extends import_three38.EventDispatcher {
    ...
    setDepthTexture(depthTexture, depthPacking = import_three38.BasicDepthPacking) {
    }
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        const property = this[key];
        if (property !== null && typeof property.dispose === "function") {
          if (property instanceof import_three38.Scene || property === this.renderer) {
            continue;
          }
          this[key].dispose();
        }
  ...
  var BloomEffect = class extends Effect {
    constructor({
      ...
      super("BloomEffect", bloom_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["map", new import_three39.Uniform(null)],
          ["intensity", new import_three39.Uniform(intensity)]
        ])
      });
      this.renderTarget = new import_three39.WebGLRenderTarget(1, 1, {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
        if (renderer.outputEncoding === import_three39.sRGBEncoding) {
          this.renderTarget.texture.encoding = import_three39.sRGBEncoding;
        }
      }
    }
  };
  ...
  var BokehEffect = class extends Effect {
    constructor({
      ...
      super("BokehEffect", bokeh_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ["focus", new import_three40.Uniform(focus)],
          ["dof", new import_three40.Uniform(dof)],
          ["aperture", new import_three40.Uniform(aperture)],
          ["maxBlur", new import_three40.Uniform(maxBlur)]
        ])
      });
    }
  };
  ...
  var BrightnessContrastEffect = class extends Effect {
    constructor({ blendFunction, brightness = 0, contrast = 0 } = {}) {
      super("BrightnessContrastEffect", brightness_contrast_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["brightness", new import_three41.Uniform(brightness)],
          ["contrast", new import_three41.Uniform(contrast)]
        ])
      });
    }
    get brightness() {
  ...
  var ColorDepthEffect = class extends Effect {
    constructor({ blendFunction, bits = 16 } = {}) {
      super("ColorDepthEffect", color_depth_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["factor", new import_three42.Uniform(1)]
        ])
      });
      this.bits = 0;
      this.bitDepth = bits;
  ...
  var ChromaticAberrationEffect = class extends Effect {
    constructor({
      blendFunction,
      offset = new import_three43.Vector2(1e-3, 5e-4),
      ...
      super("ChromaticAberrationEffect", chromatic_aberration_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ["offset", new import_three43.Uniform(offset)],
          ["modulationOffset", new import_three43.Uniform(modulationOffset)]
        ])
      });
  ...
  var DepthOfFieldEffect = class extends Effect {
    constructor(camera, {
      ...
      super("DepthOfFieldEffect", depth_of_field_default, {
        ...
        attributes: EffectAttribute.DEPTH,
        uniforms: /* @__PURE__ */ new Map([
          ["nearColorBuffer", new import_three44.Uniform(null)],
          ["farColorBuffer", new import_three44.Uniform(null)],
          ["nearCoCBuffer", new import_three44.Uniform(null)],
          ["scale", new import_three44.Uniform(1)]
        ])
      });
      this.camera = camera;
      this.renderTarget = new import_three44.WebGLRenderTarget(1, 1, {
        minFilter: import_three44.LinearFilter,
        magFilter: import_three44.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false
      });
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (renderer.outputEncoding === import_three44.sRGBEncoding) {
          this.renderTarget.texture.encoding = import_three44.sRGBEncoding;
          this.renderTargetNear.texture.encoding = import_three44.sRGBEncoding;
          this.renderTargetFar.texture.encoding = import_three44.sRGBEncoding;
          this.renderTargetMasked.texture.encoding = import_three44.sRGBEncoding;
        }
      }
    }
  };
  ...
  var DotScreenEffect = class extends Effect {
    constructor({ blendFunction, angle = Math.PI * 0.5, scale = 1 } = {}) {
      super("DotScreenEffect", dot_screen_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["angle", new import_three45.Uniform(new import_three45.Vector2())],
          ["scale", new import_three45.Uniform(scale)]
        ])
      });
      this.angle = angle;
    }
  ...
  var GammaCorrectionEffect = class extends Effect {
    constructor({ blendFunction = BlendFunction.SET, gamma = 2 } = {}) {
      super("GammaCorrectionEffect", gamma_correction_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["gamma", new import_three46.Uniform(gamma)]
        ])
      });
    }
  };
  ...
  function getNoise(size, format, type) {
    const channels = /* @__PURE__ */ new Map([
      [import_three47.LuminanceFormat, 1],
      [import_three47.RedFormat, 1],
      [import_three47.RGFormat, 2],
      [import_three47.RGBAFormat, 4]
    ]);
    let data;
    if (!channels.has(format)) {
      console.error("Invalid noise texture format");
    }
    if (type === import_three47.UnsignedByteType) {
  ...
  var NoiseTexture = class extends import_three47.DataTexture {
    constructor(width, height, format = import_three47.LuminanceFormat, type = import_three47.UnsignedByteType) {
  ...
  var GlitchEffect = class extends Effect {
    constructor({
      ...
      delay = new import_three48.Vector2(1.5, 3.5),
      duration = new import_three48.Vector2(0.6, 1),
      strength = new import_three48.Vector2(0.3, 1),
      columns = 0.05,
      ratio = 0.85,
      ...
      super("GlitchEffect", glitch_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["perturbationMap", new import_three48.Uniform(null)],
          ["columns", new import_three48.Uniform(columns)],
          ["active", new import_three48.Uniform(false)],
          ["random", new import_three48.Uniform(1)],
          ["seeds", new import_three48.Uniform(new import_three48.Vector2())],
          ["distortion", new import_three48.Uniform(new import_three48.Vector2())]
        ])
      });
      if (perturbationMap === null) {
        const map = new NoiseTexture(dtSize, dtSize, import_three48.RGBAFormat);
        map.name = textureTag;
      ...
      this.breakPoint = new import_three48.Vector2(randomFloat(this.delay.x, this.delay.y), randomFloat(this.duration.x, this.duration.y));
    ...
    set perturbationMap(value) {
      ...
      value.minFilter = value.magFilter = import_three48.NearestFilter;
      value.wrapS = value.wrapT = import_three48.RepeatWrapping;
    ...
    generatePerturbationMap(value = 64) {
      const map = new NoiseTexture(value, value, import_three48.RGBAFormat);
      map.name = textureTag;
      return map;
    }
    update(renderer, inputBuffer, deltaTime) {
  ...
  // src/effects/GodRaysEffect.js
  var v = new import_three49.Vector3();
  var m = new import_three49.Matrix4();
  var GodRaysEffect = class extends Effect {
    constructor(camera, lightSource, {
      ...
      super("GodRaysEffect", god_rays_default, {
        ...
        attributes: EffectAttribute.DEPTH,
        uniforms: /* @__PURE__ */ new Map([
          ["map", new import_three49.Uniform(null)]
        ])
      });
      this.camera = camera;
      ...
      this.lightScene = new import_three49.Scene();
      this.screenPosition = new import_three49.Vector2();
      this.renderTargetA = new import_three49.WebGLRenderTarget(1, 1, {
        minFilter: import_three49.LinearFilter,
        magFilter: import_three49.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false
      });
      ...
      this.renderTargetLight.depthTexture = new import_three49.DepthTexture();
      this.renderPassLight = new RenderPass(this.lightScene, camera);
      this.renderPassLight.clearPass.overrideClearColor = new import_three49.Color(0);
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (renderer.outputEncoding === import_three49.sRGBEncoding) {
          this.renderTargetA.texture.encoding = import_three49.sRGBEncoding;
          this.renderTargetB.texture.encoding = import_three49.sRGBEncoding;
          this.renderTargetLight.texture.encoding = import_three49.sRGBEncoding;
        }
      }
    }
  };
  ...
  var GridEffect = class extends Effect {
    constructor({ blendFunction = BlendFunction.OVERLAY, scale = 1, lineWidth = 0 } = {}) {
      super("GridEffect", grid_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["scale", new import_three50.Uniform(new import_three50.Vector2())],
          ["lineWidth", new import_three50.Uniform(lineWidth)]
        ])
      });
      this.resolution = new import_three50.Vector2();
      this.s = 0;
      this.scale = scale;
      this.l = 0;
  ...
  var HueSaturationEffect = class extends Effect {
    constructor({ blendFunction = BlendFunction.SET, hue = 0, saturation = 0 } = {}) {
      super("HueSaturationEffect", hue_saturation_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["hue", new import_three51.Uniform(new import_three51.Vector3())],
          ["saturation", new import_three51.Uniform(saturation)]
        ])
      });
      this.hue = hue;
    }
  ...
  var LUT1DEffect = class extends Effect {
    constructor(lut, { blendFunction = BlendFunction.SET } = {}) {
      super("LUT1DEffect", lut_1d_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([["lut", new import_three52.Uniform(null)]])
      });
      this.lut = lut;
    }
    get lut() {
    ...
    set lut(value) {
      ...
      if (value && (value.type === import_three52.FloatType || value.type === import_three52.HalfFloatType)) {
  ...
  var LookupTexture = class extends import_three53.DataTexture3D {
    ...
    convertLinearToSRGB() {
      ...
      if (this.type === import_three53.FloatType) {
        ...
        this.encoding = import_three53.sRGBEncoding;
        this.needsUpdate = true;
      } else {
  ...
  var LUT3DEffect = class extends Effect {
    constructor(lut, {
      ...
      inputEncoding = import_three55.sRGBEncoding
    } = {}) {
      super("LUT3DEffect", lut_3d_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["lut", new import_three55.Uniform(null)],
          ["scale", new import_three55.Uniform(new import_three55.Vector3())],
          ["offset", new import_three55.Uniform(new import_three55.Vector3())],
          ["domainMin", new import_three55.Uniform(null)],
          ["domainMax", new import_three55.Uniform(null)]
        ])
      });
    ...
    set inputEncoding(value) {
      ...
      switch (value) {
        case import_three55.sRGBEncoding:
          defines.set("linearToInputTexel(texel)", "LinearTosRGB(texel)");
          break;
        case import_three55.LinearEncoding:
      ...
      if (lut !== null) {
        const outputEncoding = lut.encoding === import_three55.LinearEncoding ? value : lut.encoding;
    ...
    set lut(value) {
      ...
      if (this.lut !== value) {
        ...
        if (value !== null) {
          ...
          if (value.type === import_three55.FloatType || value.type === import_three55.HalfFloatType) {
            defines.set("LUT_PRECISION_HIGH", "1");
          }
          if (image.width > image.height) {
            defines.set("LUT_STRIP_HORIZONTAL", "1");
          } else if (value instanceof import_three55.DataTexture3D) {
    ...
    updateScaleOffset() {
      ...
      if (lut !== null) {
        ...
        if (this.tetrahedralInterpolation && lut instanceof import_three55.DataTexture3D) {
    ...
    configureTetrahedralInterpolation() {
      const lut = this.lut;
      if (lut !== null) {
        lut.minFilter = import_three55.LinearFilter;
        lut.magFilter = import_three55.LinearFilter;
        if (this.tetrahedralInterpolation) {
          if (lut instanceof import_three55.DataTexture3D) {
            lut.minFilter = import_three55.NearestFilter;
            lut.magFilter = import_three55.NearestFilter;
          } else {
  ...
  var OutlineEffect = class extends Effect {
    constructor(scene, camera, {
      ...
      super("OutlineEffect", outline_default3, {
        uniforms: /* @__PURE__ */ new Map([
          ["maskTexture", new import_three56.Uniform(null)],
          ["edgeTexture", new import_three56.Uniform(null)],
          ["edgeStrength", new import_three56.Uniform(edgeStrength)],
          ["visibleEdgeColor", new import_three56.Uniform(new import_three56.Color(visibleEdgeColor))],
          ["hiddenEdgeColor", new import_three56.Uniform(new import_three56.Color(hiddenEdgeColor))],
          ["pulse", new import_three56.Uniform(1)],
          ["patternScale", new import_three56.Uniform(patternScale)],
          ["patternTexture", new import_three56.Uniform(null)]
        ])
      });
      ...
      this.scene = scene;
      this.camera = camera;
      this.renderTargetMask = new import_three56.WebGLRenderTarget(1, 1, {
        minFilter: import_three56.LinearFilter,
        magFilter: import_three56.LinearFilter,
        stencilBuffer: false
      });
      ...
      this.clearPass = new ClearPass();
      this.clearPass.overrideClearColor = new import_three56.Color(0);
      this.clearPass.overrideClearAlpha = 1;
      this.depthPass = new DepthPass(scene, camera);
      this.maskPass = new RenderPass(scene, camera, new DepthComparisonMaterial(this.depthPass.texture, camera));
      const clearPass = this.maskPass.clearPass;
      clearPass.overrideClearColor = new import_three56.Color(16777215);
      clearPass.overrideClearAlpha = 1;
      this.blurPass = new KawaseBlurPass({ resolutionScale, resolutionX, resolutionY, kernelSize });
      this.blurPass.enabled = blur;
      const resolution = this.blurPass.resolution;
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      this.defines.set("texelToLinear(texel)", decoding);
      this.blurPass.initialize(renderer, alpha, import_three56.UnsignedByteType);
      if (frameBufferType !== void 0) {
  ...
  var pixelation_default = "uniform bool active;uniform vec2 d;void mainUv(inout vec2 uv){if(active){uv=vec2(d.x*(floor(uv.x/d.x)+0.5),d.y*(floor(uv.y/d.y)+0.5));}}";
  ...
  var PixelationEffect = class extends Effect {
    constructor(granularity = 30) {
      super("PixelationEffect", pixelation_default, {
        uniforms: /* @__PURE__ */ new Map([
          ["active", new import_three57.Uniform(false)],
          ["d", new import_three57.Uniform(new import_three57.Vector2())]
        ])
      });
      this.resolution = new import_three57.Vector2();
      this.d = 0;
  ...
  var RealisticBokehEffect = class extends Effect {
    constructor({
      ...
      super("RealisticBokehEffect", realistic_bokeh_default, {
        ...
        attributes: EffectAttribute.CONVOLUTION | EffectAttribute.DEPTH,
        uniforms: /* @__PURE__ */ new Map([
          ["focus", new import_three58.Uniform(focus)],
          ["focalLength", new import_three58.Uniform(focalLength)],
          ["fStop", new import_three58.Uniform(fStop)],
          ["luminanceThreshold", new import_three58.Uniform(luminanceThreshold)],
          ["luminanceGain", new import_three58.Uniform(luminanceGain)],
          ["bias", new import_three58.Uniform(bias)],
          ["fringe", new import_three58.Uniform(fringe)],
          ["maxBlur", new import_three58.Uniform(maxBlur)],
          ["dof", new import_three58.Uniform(null)]
        ])
      });
      this.rings = rings;
    ...
    set manualDoF(value) {
      if (this.manualDoF !== value) {
        if (value) {
          ...
          this.uniforms.get("dof").value = new import_three58.Vector4(0.2, 1, 0.2, 2);
        } else {
  ...
  var ScanlineEffect = class extends Effect {
    constructor({ blendFunction = BlendFunction.OVERLAY, density = 1.25, scrollSpeed = 0 } = {}) {
      super("ScanlineEffect", scanlines_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["count", new import_three59.Uniform(0)],
          ["scrollSpeed", new import_three59.Uniform(0)]
        ])
      });
      this.resolution = new import_three59.Vector2();
      this.d = density;
  ...
  var v2 = new import_three60.Vector3();
  var ab = new import_three60.Vector3();
  var ShockWaveEffect = class extends Effect {
    constructor(camera, position = new import_three60.Vector3(), {
      speed = 2,
      maxRadius = 1,
      waveSize = 0.2,
      amplitude = 0.05
      ...
      super("ShockWaveEffect", shock_wave_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ["active", new import_three60.Uniform(false)],
          ["center", new import_three60.Uniform(new import_three60.Vector2(0.5, 0.5))],
          ["cameraDistance", new import_three60.Uniform(1)],
          ["size", new import_three60.Uniform(1)],
          ["radius", new import_three60.Uniform(-waveSize)],
          ["maxRadius", new import_three60.Uniform(maxRadius)],
          ["waveSize", new import_three60.Uniform(waveSize)],
          ["amplitude", new import_three60.Uniform(amplitude)]
        ])
      });
  ...
  var SelectiveBloomEffect = class extends BloomEffect {
    constructor(scene, camera, options) {
      ...
      this.depthPass = new DepthPass(scene, camera);
      this.clearPass = new ClearPass(true, false, false);
      this.clearPass.overrideClearColor = new import_three61.Color(0);
      this.depthMaskPass = new ShaderPass(new DepthMaskMaterial());
      const depthMaskMaterial = this.depthMaskMaterial;
      depthMaskMaterial.depthBuffer1 = this.depthPass.texture;
      depthMaskMaterial.depthPacking1 = import_three61.RGBADepthPacking;
      depthMaskMaterial.depthMode = import_three61.EqualDepth;
      this.renderTargetMasked = new import_three61.WebGLRenderTarget(1, 1, {
        minFilter: import_three61.LinearFilter,
        magFilter: import_three61.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false
      });
    ...
    set inverted(value) {
      ...
      this.depthMaskMaterial.depthMode = value ? import_three61.NotEqualDepth : import_three61.EqualDepth;
    }
    isInverted() {
      return this.inverted;
    }
    ...
    setDepthTexture(depthTexture, depthPacking = import_three61.BasicDepthPacking) {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        this.renderTargetMasked.texture.type = frameBufferType;
        if (renderer.outputEncoding === import_three61.sRGBEncoding) {
          this.renderTargetMasked.texture.encoding = import_three61.sRGBEncoding;
        }
      }
    }
  };
  ...
  var SepiaEffect = class extends Effect {
    constructor({ blendFunction, intensity = 1 } = {}) {
      super("SepiaEffect", sepia_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["intensity", new import_three62.Uniform(intensity)]
        ])
      });
    }
    get intensity() {
  ...
  var SMAAEffect = class extends Effect {
    constructor({
      ...
      super("SMAAEffect", smaa_default, {
        ...
        attributes: EffectAttribute.CONVOLUTION | EffectAttribute.DEPTH,
        uniforms: /* @__PURE__ */ new Map([
          ["weightMap", new import_three63.Uniform(null)]
        ])
      });
      ...
      this.renderTargetEdges = new import_three63.WebGLRenderTarget(1, 1, {
        minFilter: import_three63.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false
      });
      ...
      const loadingManager = new import_three63.LoadingManager();
      loadingManager.onLoad = () => {
        const searchTexture = new import_three63.Texture(searchImage);
        searchTexture.name = "SMAA.Search";
        searchTexture.magFilter = import_three63.NearestFilter;
        searchTexture.minFilter = import_three63.NearestFilter;
        searchTexture.generateMipmaps = false;
        searchTexture.needsUpdate = true;
        searchTexture.flipY = true;
        this.weightsMaterial.searchTexture = searchTexture;
        const areaTexture = new import_three63.Texture(areaImage);
        areaTexture.name = "SMAA.Area";
        areaTexture.magFilter = import_three63.LinearFilter;
        areaTexture.minFilter = import_three63.LinearFilter;
    ...
    setDepthTexture(depthTexture, depthPacking = import_three63.BasicDepthPacking) {
  ...
  var SSAOEffect = class extends Effect {
    constructor(camera, normalBuffer, {
      ...
      super("SSAOEffect", ssao_default3, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ["aoBuffer", new import_three64.Uniform(null)],
          ["normalDepthBuffer", new import_three64.Uniform(normalDepthBuffer)],
          ["luminanceInfluence", new import_three64.Uniform(luminanceInfluence)],
          ["color", new import_three64.Uniform(null)],
          ["scale", new import_three64.Uniform(0)]
        ])
      });
      this.renderTargetAO = new import_three64.WebGLRenderTarget(1, 1, {
        minFilter: import_three64.LinearFilter,
        magFilter: import_three64.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false
      });
      ...
      const noiseTexture = new NoiseTexture(NOISE_TEXTURE_SIZE, NOISE_TEXTURE_SIZE, import_three64.RGBAFormat);
      noiseTexture.wrapS = noiseTexture.wrapT = import_three64.RepeatWrapping;
    ...
    set color(value) {
      ...
      if (value !== null) {
        if (defines.has("COLORIZE")) {
          ...
          uniforms.get("color").value = new import_three64.Color(value);
          this.setChanged();
        }
    ...
    setDepthTexture(depthTexture, depthPacking = import_three64.BasicDepthPacking) {
  ...
  var TextureEffect = class extends Effect {
    constructor({ blendFunction, texture = null, aspectCorrection = false } = {}) {
      super("TextureEffect", texture_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ["map", new import_three65.Uniform(null)],
          ["scale", new import_three65.Uniform(1)],
          ["uvTransform", new import_three65.Uniform(null)]
        ])
      });
    ...
    set texture(value) {
      ...
      if (prevTexture !== value) {
        ...
        if (value !== null) {
          ...
          if (value.type !== import_three65.UnsignedByteType) {
  ...
  var ToneMappingEffect = class extends Effect {
    constructor({
      ...
      super("ToneMappingEffect", tone_mapping_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["luminanceBuffer", new import_three66.Uniform(null)],
          ["maxLuminance", new import_three66.Uniform(maxLuminance)],
          ["whitePoint", new import_three66.Uniform(whitePoint)],
          ["middleGrey", new import_three66.Uniform(middleGrey)],
          ["averageLuminance", new import_three66.Uniform(averageLuminance)]
        ])
      });
      this.renderTargetLuminance = new import_three66.WebGLRenderTarget(1, 1, {
        minFilter: import_three66.LinearMipmapLinearFilter,
        magFilter: import_three66.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false
      });
  ...
  var VignetteEffect = class extends Effect {
    constructor({
      ...
      super("VignetteEffect", vignette_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ["offset", new import_three67.Uniform(offset)],
          ["darkness", new import_three67.Uniform(darkness)]
        ])
      });
    }
    get technique() {
  ...
  var LUT3dlLoader = class extends import_three68.Loader {
    load(url, onLoad = () => {
    }, onProgress = () => {
    }, onError = null) {
      const externalManager = this.manager;
      const internalManager = new import_three68.LoadingManager();
      const loader = new import_three68.FileLoader(internalManager);
  ...
  var LUTCubeLoader = class extends import_three69.Loader {
    load(url, onLoad = () => {
    }, onProgress = () => {
    }, onError = null) {
      const externalManager = this.manager;
      const internalManager = new import_three69.LoadingManager();
      const loader = new import_three69.FileLoader(internalManager);
      loader.setPath(this.path);
      loader.setResponseType("text");
      return new Promise((resolve, reject) => {
        internalManager.onError = (url2) => {
    ...
    parse(input) {
      ...
      const data = new Float32Array(size ** 3 * 4);
      const domainMin = new import_three69.Vector3(0, 0, 0);
      const domainMax = new import_three69.Vector3(1, 1, 1);
  ...
  var SMAAImageLoader = class extends import_three70.Loader {
    load(onLoad = () => {
    }, onError = null) {
      ...
      const externalManager = this.manager;
      const internalManager = new import_three70.LoadingManager();
      return new Promise((resolve, reject) => {
        const searchImage = new Image();
        const areaImage = new Image();
        internalManager.onError = (url) => {
