...
var NormalPass = class extends Pass {
  constructor(scene, camera, {
    ...
    const clearPass = renderPass.getClearPass();
    clearPass.setOverrideClearColor(new Color(7829503));
...
var EffectComposer = class {
  ...
  createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
    ...
    let renderTarget;
    if (multisampling > 0) {
      renderTarget = Number(REVISION.replace(/\D+/g, "")) < 138 ? new WebGLMultisampleRenderTarget(size.width, size.height, options) : new WebGLRenderTarget(size.width, size.height, options);
